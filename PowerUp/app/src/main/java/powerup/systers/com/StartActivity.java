        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (hasPreviouslyStarted) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(StartActivity.this);
                    builder.setTitle(context.getResources().getString(R.string.login_error_title_message))
                            .setMessage(getResources().getString(R.string.login_error_dialog_message));
                    builder.setPositiveButton(getResources().getString(R.string.login_error_dismiss_message), new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            dialog.dismiss();
                        }
                    });
